...
public abstract class AbstractFormView extends JPanel{
	...
	protected void addDate(int y, int size, String nome) {
		
		
		SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy"); 
		JFormattedTextField dateChooser = new JFormattedTextField(df);
		dateChooser.setColumns(size);
		...
		inputs.put(nome, dateChooser);
		
	}
	protected void addTime(int y, int size, String nome) {
